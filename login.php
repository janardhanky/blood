...
<div style="height:400px; width:500px; margin:auto; margin-top:100px; margin-bottom:140px; background-color:#f8f1e4; border:3px solid red; box-shadow:4px 1px 30px black;">
    
    <table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
    <form method="post">
    <table border="0" align="center" width="500" height="400px" class="shaddoww">
	  <tr><td colspan="2" align="center" class="toptd">DONAR LOGIN</td></tr>
...
<tr><td class="lefttd">E-Mail Id</td><td><input type="email" name="t1" required="required"/></td></tr>
