...
<tr><td class="lefttd">Upload Pic</td><td><input type="file" name="t1" ></td></tr>
<tr><td class="lefttd">Description</td><td><textarea name="t4" /><?php if(isset($_POST["show"])){echo $detail;} ?></textarea></td></tr>
