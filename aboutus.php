...
<div class="header">
		<div class="logo">
			<h1><a href="index.php"><img src="Images/cs2.PNG" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
We remind every visitor that we have the empowerment to save lives and let’s do that – right now, right here. If you are eligible for blood donation, please register yourself as a blood donor now!</p>
			<p style="font-size:20px" class="top">We also take this opportunity to thank our whole team for all your ideas, commitment and hard-ship in making this dream a reality. We would also like to thank our friends and well-wishers for all your support and encouragement throughout this project. It is now reasonably safe to say that together we have made this society a slightly better and safer place to live.</p>
		<p  style="font-size:20px"class="top">Thank you and Happy Blood donating!</p>	
        
        <p style="font-size:40px"class="top">Promoters,</p>
<p style="font-size:40px">Blood Bank India.</p>
...
<br /><br /><br /><br /><br />
			       <div>
                       <img src="Images/doc.png" width="250px" height="200px" class="tableborder" />
						<br /><br />
                            <img src="Images/CS5.PNG" width="250px" height="200px" class="tableborder" />
