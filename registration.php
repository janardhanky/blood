...
<div class="wrap">
     ...
     <div style="height:500px; width:700px; margin:auto; margin-top:60px; margin-bottom:80px; background-color:#f8f1e4; border:3px solid red; box-shadow:4px 1px 30px black;">
    
    <table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
    <form method="post">
    <table border="0" align="center" width="700" height="500px" class="shaddoww">
	<tr><td colspan="2" align="center" class="toptd">DONAR REGISTRATION</td></tr>
    <tr><td colspan="2" align="center" class="toptd"></td></tr

    
   
<tr><td colspan="2">&nbsp;</td></tr>

                <tr><td  style=" padding-left:20px;" ><img src="Images/cs7.PNG" width="220px" height="400" class="shaddoww"/>&nbsp; </td>
...
//aloow certain file formats
	if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
		...
		$cn=makeconnection();
			...
			//$s="INSERT INTO donarregistration(name,gender,age,mobile,b_id,email,pwd,pic) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9])"
	mysqli_query($cn,$s);
	mysqli_close($cn);
	if($s>0)
	{
