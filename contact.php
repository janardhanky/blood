...
<div class="wrap">
    ...
    <div>
<div style="height:900px; width:300%; margin:auto; margin-top:100px; margin-bottom:400px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
  ...
  <div   class="col span_2_of_3"> <div class="contact-form" style="padding-left:100px;">
    ...
    <table  cellspacing="0" cellpadding="0"  width="350px" height="450px">               
